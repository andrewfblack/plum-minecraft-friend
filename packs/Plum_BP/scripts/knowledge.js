...
const PLUM_TOPICS = [
  ...
  [/\b(care|care for|take care|keep)\b/, 'Talk to me in chat while I am nearby, or hold a book and interact. Tame me with a plum, plant fruit on farmland to grow a baby, and stay within 8 blocks of me near adventures to heal slowly. Interact with an empty hand to make me sit or follow you. Craft a Fruid Basket from three sticks in the bucket shape and interact with me while holding it to carry me along.'],
  [/\b(basket|baskets|carry|carried|pick.?up|pickup|store|travel)\b/, 'Craft a Fruid Basket from three sticks in the bucket shape (two on top, one below in the middle). Hold it and interact with your tamed friend to tuck them inside. Carry the basket in your inventory, then interact with a block to let your friend out again.'],
...
const APPLE_TOPICS = [
  ...
  [/\b(care|care for|take care|keep)\b/, 'Talk to me in chat while I am nearby, or hold a book and interact. Tame me with an apple, plant fruit on farmland to grow a baby, and order from Applezon. Interact with an empty hand to make me sit or follow you. Craft a Fruid Basket from three sticks in the bucket shape and interact with me while holding it to carry me along. Unlike Plum, I do not heal you; stand near your tamed Plum for regeneration instead.'],
  [/\b(basket|baskets|carry|carried|pick.?up|pickup|store|travel)\b/, 'Craft a Fruid Basket from three sticks in the bucket shape (two on top, one below in the middle). Hold it and interact with your tamed friend to tuck them inside. Carry the basket in your inventory, then interact with a block to let your friend out again.'],
