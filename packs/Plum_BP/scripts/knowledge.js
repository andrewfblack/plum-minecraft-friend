...
const PLUM_TOPICS = [
  ...
  [/\b(care|care for|take care|keep)\b/, 'Talk to me in chat while I am nearby, or hold a book and interact. Tame me with a plum, breed adults with plums, and stay within 8 blocks of me near adventures to heal slowly.'],
  ...
  [/\b(tame|taming|follow|friend)\b/, 'Give me a plum fruit to become my owner. I will follow you! Type my name in chat when I am near, or hold a book and interact with me to talk.'],
...
const APPLE_TOPICS = [
  ...
  [/\b(care|care for|take care|keep)\b/, 'Talk to me in chat while I am nearby, or hold a book and interact. Tame me with an apple, breed adults with apples, and order from Applezon. Unlike Plum, I do not heal you; stand near your tamed Plum for regeneration instead.'],
  [/\b(tree|trees|sapling|saplings|orchard|fruit)\b|where.*\bapples\b/, 'Find apple trees in newly explored plains and forests. Break their red-speckled leaves for a chance of apples and saplings. Plant a sapling on dirt or grass with 5 blocks of width and 6 blocks of height clear. It grows while loaded, or use bone meal. Feed the apples to two tamed adult Apples to breed them!'],
  ...
  [/\b(breed|breeding|babies|baby|grow)\b/, 'Give an apple to each tamed adult Apple while they are close together. A little Apple will appear! Babies grow up in about 20 loaded minutes; apples speed that up. Tame your baby with an apple too.'],
  [/\b(tame|taming|follow|friend)\b/, 'Give me an apple fruit to become my owner. I will follow you and deliver from Applezon! Type my name in chat when I am near, or hold a book and interact with me to talk or shop.'],
  [/\b(heal|healing|hurt|health|help)\b/, 'I am Apple, owner of Applezon, and I do NOT grant healing. Stay near your tamed Plum for gentle regeneration, or keep a bed and good food handy. I can still answer crafting, beds, torches, mining, farming, and breeding questions.'],
