...
```json
[{"pack_id":"01d84fd1-31dd-4b92-a942-c8e59ce38191","version":[1,2,30]}]
```

Resource pack:

```json
[{"pack_id":"834d72cc-8c7f-498f-adfa-269e215f86e8","version":[1,2,30]}]
```
...
On mobile or Windows Bedrock, add the server address and configured Bedrock port, join, and accept the resources. Spawn and tame Plum as described in the main README, hold a **book**, and interact. Choose **Ask a question**. A newly tamed friend stays put. Interact with a Plum, Apple, Lemon, Banana, or Grapes with an empty hand to open the **Movement** menu: **Follow** (up to six friends may follow you), **Stay**, **Work** (keeps a friend within 20 blocks of the spot you pick), or **Go Home** (sends a friend back to your bed — sleep in one first — where it roams within 10 blocks). **Blueberry** is the Collector: interact with him with an empty hand to open his portable chest, and dropped items within four blocks go straight inside; his chest menu also opens Movement. **Strawberry** is the Farmer: interact with him with an empty hand to open his farm chest, where Movement lives too; set to Work he tends a field (speeds crops, harvests, replants), while following/staying/home he forages instead (harvests without replanting and breaks grass for seeds), and all of it goes into his chest. **Lemon** is the Light Friend: he stays bright in darkness and casts moving block light at his feet while tamed and loaded. **Banana** is the Prankster: about every 30 seconds he drops a non-pickup peel trap; the first hostile mob that steps close slips and slows, while an unused peel removes itself after two minutes. **Grapes** is the Sharpshooter: a tamed Grapes takes aim at hostile mobs within 12 blocks and spits arc-balling grape seeds at them every couple of seconds. **Coconut** is the Bodyguard: about every three seconds he checks around him and, if any monster is close, slams the ground — every hostile in the blast is knocked flying with a bit of damage; set him to Work to guard that spot with a wider 8-block radius, or leave him following/staying/home to escort you at up to 6 blocks. Craft a **Fruit Basket** from three sticks in the bucket shape, hold it while interacting with a tamed friend to carry it around, and interact with a block to let it out again — a friend released from a basket always stays put until you order it otherwise.
...
To grow babies, plant a plum, apple, blueberry, lemon, banana, grape, strawberry, or coconut fruit on tilled farmland: a sprout appears and grows into a baby friend. Find the matching trees in new plains/forest terrain (grape vines here too; lemon trees in warm biomes like deserts, savannas and jungles, banana trees in jungles, low strawberry bushes in plains, tall coconut palms on beaches) and break their fruit-speckled leaves in Survival. Each leaf has a 35% fruit-drop chance and a separate 10% sapling-drop chance. Plant saplings on soil with a clear 5-wide, 6-high space; wait for random growth or use bone meal. Grape saplings only need 5-wide, 3-high and grow into a low leaf mound hiding a single log; strawberry saplings need just a tiny 3-wide, 2-high pocket and grow into an even smaller leafy mound; coconut saplings grow on sand too and need 5-wide, 7-high to become a tall slim palm. Apples do not grow Plums. Leaves do not automatically decay.
...
- **Plum will not grow from fruit:** plant a plum fruit on tilled farmland (assert the block is farmland) and wait for the sprout. Only planting creates a baby — breeding was removed.
