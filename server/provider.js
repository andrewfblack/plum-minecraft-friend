...
export const chatLabel = 'AI chat • Questions go to the server’s AI service';
...
export async function answerQuestion(question, context) {
  try {
    ...
    request.body = JSON.stringify({ question: cleanText(question), playerId: context.playerId, dimension: context.dimension, baby: context.baby });
    ...
    return `My AI connection is resting. Here is my offline help: ${offlineAnswer(question)}`;
  }
}
