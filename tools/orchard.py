...
def build_fruit(bp, rp, root, write, png, fruit, accumulate):
    item, leaf, sapling_block, tree, rule, component = (f'{fruit}:{fruit}', f'{fruit}:{fruit}_leaves', f'{fruit}:{fruit}_sapling', f'{fruit}:{fruit}_tree', f'{fruit}:{fruit}_tree_rule', f'{fruit}:grow_tree')
    write(bp / f'items/{fruit}.json', {
        ...
        'minecraft:item': {
            ...
            'components': {
                ...
                'minecraft:custom_components': ['friend:plant']
            }
        }
    })
