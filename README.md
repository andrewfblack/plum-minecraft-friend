...
4. **Sit like a dog:** interact with an **empty hand** to make a tamed friend sit and stay put. Interact with an empty hand again to make him stand and follow you. Sitting friends stay put while you build or explore.
5. **Carry him in a basket:** craft a **Fruid Basket** from three sticks in the bucket shape (two on top, one below in the middle). Hold it and interact with a tamed friend to tuck him inside. Carry the basket in your inventory, then interact with **any block** to let him out again — name, baby/sit state, and his owner all come back.
...
- Interact with an empty hand on a tamed friend and confirm it stays put; interact again and confirm it resumes following.
- Craft a Fruid Basket from three sticks, hold it and interact with a tamed friend, then interact with a block to release it; confirm the name, baby/sit state, and owner return.
