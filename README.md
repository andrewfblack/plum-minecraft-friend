...
5. **Carry him in a basket:** craft a **Fruit Basket** from three sticks in the bucket shape (two on top, one below in the middle). Hold it and interact with a tamed friend to tuck him inside. Carry the basket in your inventory, then interact with **any block** to let him out again — name, baby/sit state, and his owner all come back.
